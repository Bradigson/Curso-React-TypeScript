...
import { registrarDocentes } from '../services/registrar.docentes';
...
const AgregarDocentes = ()=>{
    ...
    const handleRegistrarDocente  = async (e:any)=>{
        ...
        if(validator.isEmpty(request.nombreDocente)){
            ...
            await registrarDocentes(request)
            .then((res)=>{
                if(res.status == 200){
    ...
    return(
        <section className='modal-create_docentes'>
            ...
            <div className="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" >
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="exampleModalToggleLabel">Agregar Docentes</h1>
                        ...
                        <form>
                            ...
                            <div className='mt-3'>
                                <button className='btn-enviar-docentes' onClick={(e)=> handleRegistrarDocente(e)}>
                                    {
                                        loadinDocente ? (<div>Enviando...</div>):( <div>Enviar</div>)
                                    }
                                </button>
                            </div>
            ...
            <button className='button-add-docente' data-bs-target="#exampleModalToggle" data-bs-toggle="modal"><i className='bx bxs-folder-plus text-success'></i></button>
        </section>
    )
}
